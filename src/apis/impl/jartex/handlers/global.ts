import type { JartexNetwork } from "../../../../libraries/craftigames";
import type { GlobalMode, PlayerGuild } from "../../../../types";

async function handleGlobalCall(jartex: JartexNetwork, playerName: string): Promise<GlobalMode> {
    const profile = await jartex.getProfileData(playerName);
